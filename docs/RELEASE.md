...
4. Manually start this repository's release workflow with the same version and
   binary tag.
...
6. Verify `npm install @vx.rs/pannonico@X.Y.Z` in a new registry-only project.
